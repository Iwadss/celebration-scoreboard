...
interface TeamSetupProps {
  onStartGame: (teams: Team[], gameName: string) => void;
}
...
const TeamSetup = ({ onStartGame }: TeamSetupProps) => {
  ...
  const handleStartGame = () => {
    ...
    onStartGame(gameTeams, gameName.trim() || "Game Session");
  };
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground font-body text-lg">
              Set up teams and let the games begin!
            </p>
          </div>
          ...
          >
            ...
            <div className="mb-6 flex items-center gap-4">
              <h2 className="font-display font-semibold text-xl text-foreground whitespace-nowrap">
                Game Name
              </h2>
              <Input
                placeholder="Enter game name (e.g., Championship Finals)..."
                value={gameName}
                onChange={(e) => setGameName(e.target.value)}
                className="font-body text-lg flex-1"
              />
            </div>
